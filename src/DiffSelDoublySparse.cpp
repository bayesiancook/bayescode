...
//                 "conditions k=1..K-1).\n";
//         cerr << "the site-specific masks determine whether an amino-acid is or is not allowed at
//         a "
//                 "given site;\n";
...
//         cerr
//             << "  F_kia = m_ia * d_kia * F_kia + m_ia * (1 - m_ia * d_kia) * F_0ia, for
//             k=1..K-1\n";
...
//                 "quantified:\n";
//         cerr << " - for a given site i and a given amino acid a, by the posterior probability
//         that "
//                 "d_kia is equal to 1;\n";
...
//         // cerr << "of note, setting pi_k = 0.5, and noting pp_k the post prob that shiftprob_k >
//         0,
//         // then the Bayes factor in favor of the alternative against the null is given by BF =
//         pp_k
//         // / (1 - pp_k)\n";
//         cerr << "\n";
...
//             fitnessshape, fitnesscentermode, epsilon, pihypermean, shiftprobmean,
//             shiftprobinvconc,
