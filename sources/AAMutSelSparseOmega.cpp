...
class AAMutSelSparseOmegaChain : public Chain  {
  ...
  public:
    ...
    AAMutSelSparseOmegaChain(string indatafile, string intreefile, int inomegamode, int inevery, int inuntil, string inname, int force) : modeltype("AAMUTSELSparseOMEGA"), datafile(indatafile), treefile(intreefile), omegamode(inomegamode)  {
        every = inevery;
        until = inuntil;
        name = inname;
        New(force);
    ...
    void New(int force) override {
        cerr << "new model\n";
        model = new AAMutSelSparseOmegaModel(datafile,treefile,omegamode);
        cerr << "allocate\n";
        GetModel()->Allocate();
        cerr << "update\n";
        GetModel()->Update();
...
int main(int argc, char* argv[])	{
    ...
    // new chain
        ...
        chain = new AAMutSelSparseOmegaChain(datafile,treefile,omegamode,every,until,name,force);
    }
