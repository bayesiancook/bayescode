...
/**
 * \brief Chain object for running an MCMC under BranchNucModel
 */
...
class GeneBranchStrandSymmetricChain : public Chain {
  ...
  public:
    ...
    GeneBranchStrandSymmetricChain(string indatafile, string intreefile, string intaxonfile, int insyn_devmode, int inevery, int inuntil, string inname,
                     int force)
        : modeltype("BRANCHNUC"), datafile(indatafile), treefile(intreefile), taxonfile(intaxonfile) {
        every = inevery;
        until = inuntil;
    ...
    BranchNucModel *GetModel() { return static_cast<BranchNucModel *>(model); }
...
int main(int argc, char *argv[]) {
    ...
    // new chain
        ...
        chain = new GeneBranchStrandSymmetricChain(datafile, treefile, taxonfile, syn_devmode, every, until, name, force);
    }
