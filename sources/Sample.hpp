 ...
 * and computing posterior quantities (averages, credible intervals, distributions, posterior predictive samples. etc).
 * As a simple example, see SingleOmegaSample.
 */

class Sample	{

	public:
			//! \brief Constructor, opening chain from file, with specified burn-in, thinning factor and upper limit.
	...
	string		GetName() {return name;}
			...
			//! \brief get the next point (automatically accounts for subsampling, as specified by the thinning parameter)
			//!
