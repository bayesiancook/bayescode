...
#include "NoisyConditionSpecificMeanGammaMixArray.hpp"
...
class NoisyGeneBranchGammaEffects    {
    ...
    NoisyGeneBranchGammaEffects(int inNgene, int inNbranch, const Selector<double>* intimescale,
        ...
        mean_bidimarray = new BidimProduct(*gene_array, *branch_array);
            ...
            dev_bidimarray =
                new NoisyConditionSpecificMeanGammaMixBidimArray(*mean_bidimarray, *timescale,
                        dev_invshape, dev_mean2, dev_invshape2, dev_pi, relative);
    }
    ...
    double GeneBranchSuffStatLogProb(int gene, int branch, SS get_ss, int gibbs_resample, double& postprob) const {
        ...
        if (dev_pi) {
            ...
            double alpha2 = 1.0 / dev_invshape2;
            double beta2 = alpha2 / dev_mean2;
            if (relative)   {
                beta2 *= timescale->GetVal(branch);
            }
    ...
    NoisyConditionSpecificMeanGammaMixBidimArray *dev_bidimarray;
