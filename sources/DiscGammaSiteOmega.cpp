...
class DiscGammaSiteOmegaChain : public Chain {
  ...
  public:
    DiscGammaSiteOmegaModel *GetModel() { return static_cast<DiscGammaSiteOmegaModel *>(model); }
...
int main(int argc, char *argv[]) {
    ...
    // new chain
        ...
        DiscGammaSiteOmegaChain *chain =
            new DiscGammaSiteOmegaChain(datafile, treefile, Ncat, every, until, name, force);
        cerr << "chain " << name << " started\n";
        chain->Start();
        cerr << "chain " << name << " stopped\n";
        cerr << chain->GetSize()
