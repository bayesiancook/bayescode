...
class EpsRobustBranchOmegaSample : public Sample {
  ...
  public:
    ...
    EpsRobustBranchOmegaModel *GetModel() override { return (EpsRobustBranchOmegaModel *)model; }

    //! \brief Constructor (file name, burn-in, thinning and upper limit, see
    //! Sample)
    EpsRobustBranchOmegaSample(string filename, int inburnin, int inevery, int inuntil)
...
int main(int argc, char *argv[]) {
    ...
    EpsRobustBranchOmegaSample *sample = new EpsRobustBranchOmegaSample(name, burnin, every, until);
    if (ppred) {
        sample->PostPred();
    } else {
        sample->Read();
