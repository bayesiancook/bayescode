...
class CodonM2aChain : public Chain {
  private:
    // Chain parameters
    string modeltype, datapath, dsomsuffstatfile;
    double pi;
  ...
  public:
    ...
    CodonM2aChain(string indatapath, string indsomsuffstatfile, double inpi, 
        ...
        : modeltype("FASTCODONM2A"), datapath(indatapath),
    ...
    void New(int force) override {
        model = new CodonM2aModel(datapath, dsomsuffstatfile, pi);
    ...
    void Open() override {
        ...
        is >> modeltype;
        is >> datapath >> dsomsuffstatfile >> pi;
    ...
    void Save() override {
        ...
        param_os << datapath << '\t' << dsomsuffstatfile << '\t' << pi << '\n';
...
int main(int argc, char *argv[]) {
    ...
    if (argc == 1)  {
        ...
        cerr << "\n";
        cerr << "fast versino of the M2a model of codeml (Muse and Gaut version)\n";
        ...
        cerr << '\n';
        cerr << "command: fastcodonm2a -d <suffstatfile> <chainname>\n";
        cerr << '\n';
    ...
    // new chain
        ...
        CodonM2aChain *chain = new CodonM2aChain(datapath, dsomsuffstatfile, pi, puromhypermean, puromhyperinvconc, dposomhypermean, dposomhyperinvshape, purwhypermean, purwhyperinvconc, poswhypermean, poswhyperinvconc, every, until, name, force);
        cerr << "chain " << name << " started\n";
        chain->Start();
        cerr << "chain " << name << " stopped\n";
        cerr << chain->GetSize()
