...
class MultiGeneSingleOmegaChain : public MultiGeneChain {
  ...
  public:
    ...
    MultiGeneSingleOmegaChain(string indatafile, string intreefile, int inevery, int inuntil,
...
int main(int argc, char *argv[]) {
    ...
    // new chain
        ...
        chain = new MultiGeneSingleOmegaChain(datafile, treefile, every, until, name, force, myid,
                                              nprocs);
    }
