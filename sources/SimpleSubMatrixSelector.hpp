 ...
 * Accordingly, SimpleMGOmegaCodonSubMatrixSelector returns, for a given branch and a given site,
...
class SimpleSubMatrixSelector : public BranchSelector<SubMatrix> {
    ...
    SimpleSubMatrixSelector(const Selector<SubMatrix>& inmatrixarray, const BranchAllocationSystem& inbranchalloc) : 
...
class SimpleMGOmegaCodonSubMatrixSelector : public BranchSelector<MGOmegaCodonSubMatrix> {
    ...
    public:
    //! constructor, parameterized by bidim array of substitution matrices and branch allocation system
    SimpleMGOmegaCodonSubMatrixSelector(const Selector<MGOmegaCodonSubMatrix>& inmatrixarray, const BranchAllocationSystem& inbranchalloc) : 
        matrixarray(inmatrixarray), branchalloc(inbranchalloc)    {
 ...
 * Accorddingly, RootSimpleMGOmegaCodonSubMatrixSelector returns, for a given site,
