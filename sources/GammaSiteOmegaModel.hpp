...
class GammaSiteOmegaModel : public ProbModel {
  ...
  public:
    ...
    void UpdateCodonMatrices() { codonmatrixarray->UpdateCodonMatrices(); }
    ...
    void MoveBranchLengthsHyperParameter() {
        ...
        ScalingMove(lambda, 1.0, 10, &GammaSiteOmegaModel::BranchLengthsHyperLogProb,
                    &GammaSiteOmegaModel::NoUpdate, this);
        ScalingMove(lambda, 0.3, 10, &GammaSiteOmegaModel::BranchLengthsHyperLogProb,
                    &GammaSiteOmegaModel::NoUpdate, this);
    ...
    void MoveOmegaHyperParameters() {
        ...
        ScalingMove(omegamean, 1.0, 10, &GammaSiteOmegaModel::OmegaHyperLogProb,
                    &GammaSiteOmegaModel::NoUpdate, this);
        ScalingMove(omegamean, 0.3, 10, &GammaSiteOmegaModel::OmegaHyperLogProb,
                    &GammaSiteOmegaModel::NoUpdate, this);
        ScalingMove(omegainvshape, 1.0, 10, &GammaSiteOmegaModel::OmegaHyperLogProb,
                    &GammaSiteOmegaModel::NoUpdate, this);
        ScalingMove(omegainvshape, 0.3, 10, &GammaSiteOmegaModel::OmegaHyperLogProb,
                    &GammaSiteOmegaModel::NoUpdate, this);
        double alpha = 1.0 / omegainvshape;
        double beta = alpha / omegamean;
        omegaarray->SetShape(alpha);
    ...
    void MoveNucRates() {
        ...
        ProfileMove(nucrelrate, 0.1, 1, 3, &GammaSiteOmegaModel::NucRatesLogProb,
                    &GammaSiteOmegaModel::UpdateNucMatrix, this);
        ProfileMove(nucrelrate, 0.03, 3, 3, &GammaSiteOmegaModel::NucRatesLogProb,
                    &GammaSiteOmegaModel::UpdateNucMatrix, this);
        ProfileMove(nucrelrate, 0.01, 3, 3, &GammaSiteOmegaModel::NucRatesLogProb,
                    &GammaSiteOmegaModel::UpdateNucMatrix, this);

        ProfileMove(nucstat, 0.1, 1, 3, &GammaSiteOmegaModel::NucRatesLogProb,
                    &GammaSiteOmegaModel::UpdateNucMatrix, this);
        ProfileMove(nucstat, 0.01, 1, 3, &GammaSiteOmegaModel::NucRatesLogProb,
                    &GammaSiteOmegaModel::UpdateNucMatrix, this);
