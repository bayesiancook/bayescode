...
/**
 * \brief A sufficient statistic for a multinomial mixture allocation vector (see MultinomialAllocationVector)
 *
 ...
 * OccupancySuffStat simply stores the counts (numbers of sites allocated to each component),
 * which is a sufficient statistic for the underlying component weights.
 *
 */
