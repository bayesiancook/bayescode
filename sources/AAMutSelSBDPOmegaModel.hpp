...
class AAMutSelSBDPOmegaModel : public ProbModel {
  ...
  public:
    ...
    AAMutSelSBDPOmegaModel(string datafile, string treefile, int inomegamode, int inomegaprior, int inNcat) :
        basesuffstat(Naa) {
        blmode = 0;
        nucmode = 0;
    ...
    AAMutSelSBDPOmegaModel(const CodonSequenceAlignment* incodondata, const Tree* intree, int inomegamode, int inomegaprior, int inNcat) :
        basesuffstat(Naa) {
    ...
    void MoveLambda() {
        ...
        ScalingMove(lambda, 1.0, 10, &AAMutSelSBDPOmegaModel::LambdaHyperLogProb,
                    &AAMutSelSBDPOmegaModel::NoUpdate, this);
        ScalingMove(lambda, 0.3, 10, &AAMutSelSBDPOmegaModel::LambdaHyperLogProb,
                    &AAMutSelSBDPOmegaModel::NoUpdate, this);
        blhypermean->SetAllBranches(1.0 / lambda);
    }
    ...
    void MoveNucRates() {
        ProfileMove(nucrelrate, 0.1, 1, 3, &AAMutSelSBDPOmegaModel::NucRatesLogProb,
                    &AAMutSelSBDPOmegaModel::UpdateMatrices, this);
        ProfileMove(nucrelrate, 0.03, 3, 3, &AAMutSelSBDPOmegaModel::NucRatesLogProb,
                    &AAMutSelSBDPOmegaModel::UpdateMatrices, this);
        ProfileMove(nucrelrate, 0.01, 3, 3, &AAMutSelSBDPOmegaModel::NucRatesLogProb,
                    &AAMutSelSBDPOmegaModel::UpdateMatrices, this);

        ProfileMove(nucstat, 0.1, 1, 3, &AAMutSelSBDPOmegaModel::NucRatesLogProb,
                    &AAMutSelSBDPOmegaModel::UpdateMatrices, this);
        ProfileMove(nucstat, 0.01, 1, 3, &AAMutSelSBDPOmegaModel::NucRatesLogProb,
                    &AAMutSelSBDPOmegaModel::UpdateMatrices, this);
    }
    ...
    void MoveKappa() {
        ScalingMove(kappa, 1.0, 10, &AAMutSelSBDPOmegaModel::StickBreakingHyperLogProb,
                    &AAMutSelSBDPOmegaModel::NoUpdate, this);
        ScalingMove(kappa, 0.3, 10, &AAMutSelSBDPOmegaModel::StickBreakingHyperLogProb,
                    &AAMutSelSBDPOmegaModel::NoUpdate, this);
        weight->SetKappa(kappa);
    }
    ...
    void MoveBase() {
        ...
        ProfileMove(basecenter, 1.0, 1, 3, &AAMutSelSBDPOmegaModel::BaseLogProb,
                    &AAMutSelSBDPOmegaModel::NoUpdate, this);
        ProfileMove(basecenter, 1.0, 3, 3, &AAMutSelSBDPOmegaModel::BaseLogProb,
                    &AAMutSelSBDPOmegaModel::NoUpdate, this);
        ProfileMove(basecenter, 0.3, 1, 3, &AAMutSelSBDPOmegaModel::BaseLogProb,
                    &AAMutSelSBDPOmegaModel::NoUpdate, this);

        ScalingMove(baseconcentration, 1.0, 10, &AAMutSelSBDPOmegaModel::BaseLogProb,
                    &AAMutSelSBDPOmegaModel::NoUpdate, this);
        ScalingMove(baseconcentration, 0.3, 10, &AAMutSelSBDPOmegaModel::BaseLogProb,
                    &AAMutSelSBDPOmegaModel::NoUpdate, this);
