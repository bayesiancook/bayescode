...
// note that, when poswmode == 0, only poswhypermean and poswhyperinvconc are fixed, on the other hand, pi is free
// pi can be fixed by setting pihyperinvconc to 0 (in which case pi is set equal to pihypermean)
//
