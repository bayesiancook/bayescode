...
int main(int argc, char* argv[])	{
	...
	MultiGeneAAMutSelM2aModel* model = new MultiGeneAAMutSelM2aModel(datafile,treefile,pihypermean,pihyperinvconc,myid,nprocs);
    ...
    model->SetMixtureHyperParameters(dposomhypermean,dposomhyperinvshape,poswhypermean,poswhyperinvconc);
    if (! myid) {
