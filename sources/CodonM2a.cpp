...
int main(int argc, char *argv[]) {
    if (argc == 1) {
        ...
        cerr << " (hyperparams: poswhypermean and poswhyperinvconc). Thus, setting pi = 0 imposes "
                "a model without positive selection.\n";
        cerr << '\n';
        ...
        cerr << "in a multigene context, they can be either fixed or estimated across genes (see "
                "multigenecodonm2a).\n";
        cerr << '\n';
