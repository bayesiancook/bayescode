...
class DiffSelChain : public Chain {
  ...
  public:
    ...
    DiffSelChain(string indata, string intree, int incategory, int inlevel, int inevery, int inuntil, int infixglob,
                 int infixvar, int incodonmodel, string inname, int force)
        : modeltype("DIFFSEL"),
          datafile(indata),
          treefile(intree),
...
int main(int argc, char* argv[]) {
    ...
    // this is a new chain
        ...
        DiffSelChain* chain =
            new DiffSelChain(datafile, treefile, ncond, nlevel, every, until, fixglob, fixvar, codonmodel, name, true);
        chain->Start();
    }
}
