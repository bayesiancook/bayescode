...
- [Site-specific rate of evolution](#site-specific-rate-of-evolution)
  1. Mutation-selection codon models (ω<sub>0</sub> and S<sub>0</sub>)
...
### I. Mutation-selection codon models (ω<sub>0</sub> and S<sub>0</sub>)
...
```
**Posterior site-specific rate of evolution (ω<sub>0</sub>)**\
...
**Posterior scaled selection coefficient for a codon transition (S<sub>0</sub>)**\
...
A python script `fitness_to_selcoeff.py` is available to compute scaled selection coefficients (S<sub>0</sub>) from a list of codon transitions.\
...
**Posterior site-specific rate of evolution (ω<sub>∗</sub>)**\
